...
This is the Play backend socket.io support for [Engine.IO v3](https://github.com/socketio/engine.io-protocol/tree/v3) protocol.

Engine.IO v4 is not supported.
